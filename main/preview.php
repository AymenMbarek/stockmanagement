...
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
	...
	<center><div style="font:bold 25px 'Aleo';">Facturation</div>
...
<div class="pull-right" style="margin-right:100px;">
		<a href="javascript:Clickheretoprint()" style="font-size:20px;"><button class="btn btn-success btn-large"><i class="icon-print"></i> Print facture</button></a>
		</div>	
</div>
</div>
