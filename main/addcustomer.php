...
<span>Type: </span><input type="text" style="width:265px; height:30px;" name="type" placeholder="Type(client/prospect)"/><br>
<span>Sexe: </span><input type="text" style="width:265px; height:30px;" name="sexe" placeholder="Homme / Femme"/><br>
<span>Date prise contact: </span><input type="date" style="width:265px; height:30px;" name="datepr" placeholder="Total"/><br>
