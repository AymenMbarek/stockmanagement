...
<a rel="facebox" href="addproduct.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;
" /><i class="icon-plus-sign icon-large"></i> Add Product</button></a><br><br>
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td><?php echo implode('/', array_reverse(explode('-', $row['date_arrival']))); // Affiche : 16/05/2010; ?></td>
			<td><?php echo implode('/', array_reverse(explode('-', $row['expiry_date']))); // Affiche : 16/05/2010; ?></td>
			<td><?php
			$oprice=$row['o_price'];
